...
public final class VanillaMaterials {
	...
	public static final Solid SIGN_POST = (Solid) register(new Solid("Sign Post", 63).setHardness(1.0F).setResistance(1.6F));
	...
	public static final Solid WALL_SIGN = (Solid) register(new Solid("Wall Sign", 68).setHardness(1.0F));
